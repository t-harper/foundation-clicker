...
import { selectProductionRates } from '@desktop/store/selectors';
import { formatNumber, formatDuration } from '@desktop/utils/format';
import { SparklineChart } from '@desktop/components/stats/SparklineChart';
import type { ResourceKey } from '@foundation/shared';
import { ERA_DEFINITIONS } from '@foundation/shared';
import type { StatsSnapshot } from '@desktop/store/stats-slice';
    ...
    <div className="space-y-4 pb-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="text-xs text-[var(--era-text)]/40 active:text-[var(--era-text)]/70 transition-colors px-2 py-1"
        >
          Clear History
        </button>
      </div>
      ...
      <section>
        <h3 className="text-sm font-semibold text-[var(--era-secondary)] mb-2">
          Peak Production Rates
        </h3>
        <div className="grid grid-cols-2 gap-2">
          {RESOURCE_KEYS.map((key) => (
            ...
            >
              ...
              <div className="text-base font-semibold" style={{ color: RESOURCE_COLORS[key] }}>
      ...
      <section>
        ...
        {totalTrackedTime === 0 ? (
          <div className="rounded-lg bg-[var(--era-surface)]/60 border border-[var(--era-primary)]/10 p-3">
            <p className="text-xs text-[var(--era-text)]/30 leading-relaxed">
            ...
            {([0, 1, 2, 3] as const).map((era) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="text-base font-semibold text-[var(--era-primary)]">
